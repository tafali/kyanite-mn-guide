    ...
    <v-row>
      <v-col cols="5">
        <v-text-field
          ...
          outlined
          hint="If you use IPv6, it must be in square brackets"
          v-model="d.serverIp"
        ></v-text-field>
      </v-col>
      <v-col cols="5">
